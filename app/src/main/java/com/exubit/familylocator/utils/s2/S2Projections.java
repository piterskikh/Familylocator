...
public class S2Projections {
    ...
    public static final Metric MIN_AREA = new Metric(2,
            S2_PROJECTION == Projections.S2_LINEAR_PROJECTION ? 1 / (3 * Math.sqrt(3)) : // 0.192
                    S2_PROJECTION == Projections.S2_TAN_PROJECTION ? (M_PI * M_PI)
                            / (16 * M_SQRT2) : // 0.436
    ...
    public static final Metric MAX_AREA = new Metric(2,
            S2_PROJECTION == Projections.S2_LINEAR_PROJECTION ? 1 : // 1.000
                    S2_PROJECTION == Projections.S2_TAN_PROJECTION ? M_PI * M_PI / 16 : // 0.617
                            S2_PROJECTION == Projections.S2_QUADRATIC_PROJECTION
                                    ? 0.65894981424079037 : // 0.659
                                    0);
    public static final Metric AVG_AREA = new Metric(2, M_PI / 6); // 0.524)
    ...
    public static final Metric MIN_ANGLE_SPAN = new Metric(1,
            S2_PROJECTION == Projections.S2_LINEAR_PROJECTION ? 0.5 : // 0.500
                    S2_PROJECTION == Projections.S2_TAN_PROJECTION ? M_PI / 4 : // 0.785
            ...
            S2_PROJECTION == Projections.S2_LINEAR_PROJECTION ? 1 : // 1.000
                    S2_PROJECTION == Projections.S2_TAN_PROJECTION ? M_PI / 4 : // 0.785
                            S2_PROJECTION == Projections.S2_QUADRATIC_PROJECTION
                                    ...
                                    0);
    public static final Metric AVG_ANGLE_SPAN = new Metric(1, M_PI / 4); // 0.785
    ...
    public static final Metric MIN_WIDTH = new Metric(1,
            (S2Projections.S2_PROJECTION == Projections.S2_LINEAR_PROJECTION ? 1 / Math.sqrt(6) : // 0.408
                    S2_PROJECTION == Projections.S2_TAN_PROJECTION ? M_PI / (4 * M_SQRT2) : // 0.555
                            S2_PROJECTION == Projections.S2_QUADRATIC_PROJECTION ? M_SQRT2 / 3 : // 0.471
                                    0));
    ...
    public static final Metric MIN_EDGE = new Metric(1,
            S2_PROJECTION == Projections.S2_LINEAR_PROJECTION ? M_SQRT2 / 3 : // 0.471
                    S2_PROJECTION == Projections.S2_TAN_PROJECTION ? M_PI / (4 * M_SQRT2) : // 0.555
                            S2_PROJECTION == Projections.S2_QUADRATIC_PROJECTION ? M_SQRT2 / 3 : // 0.471
                                    0);
    ...
    public static final Metric MIN_DIAG = new Metric(1,
            S2_PROJECTION == Projections.S2_LINEAR_PROJECTION ? M_SQRT2 / 3 : // 0.471
                    S2_PROJECTION == Projections.S2_TAN_PROJECTION ? M_PI / (3 * M_SQRT2) : // 0.740
                            S2_PROJECTION == Projections.S2_QUADRATIC_PROJECTION
                                    ? 4 * M_SQRT2 / 9 : // 0.629
                                    0);
    public static final Metric MAX_DIAG = new Metric(1,
            S2_PROJECTION == Projections.S2_LINEAR_PROJECTION ? M_SQRT2 : // 1.414
                    S2_PROJECTION == Projections.S2_TAN_PROJECTION ? M_PI / Math.sqrt(6) : // 1.283
                            S2_PROJECTION == Projections.S2_QUADRATIC_PROJECTION
    ...
    public static final double MAX_EDGE_ASPECT =
            S2_PROJECTION == Projections.S2_LINEAR_PROJECTION ? M_SQRT2 : // 1.414
                    S2_PROJECTION == Projections.S2_TAN_PROJECTION ? M_SQRT2 : // 1.414
